...
//PROGRAMAREN LETRA MOTA DESBERDINAK
public class LetraMotak 
{
	//FONT
	...
	public final static Font ERABILTZAILETITULUA = new Font("Arial", Font.BOLD, 60);
	public final static Font IZENAetaPASAHITZA = new Font("Segoe UI", Font.PLAIN, 20);
}
